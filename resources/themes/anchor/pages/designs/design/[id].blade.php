            ...
            <div class="">
                ...
                <div class="lg:grid lg:grid-cols-2">
                    <div class="aspect-w-16 aspect-h-9 w-full align-middle rounded-lg mb-2 lg:mb-0">
                        <!--change src to appropriate url --><img
                            src="https://cong.test/storage/{{$design->card_image}}" alt="{{ $design->name }}"
                            class="w-full h-auto">
                    </div>
                    ...
                    <div class="px-4 lg:px-8">
                        ...
                        @if($design->components->count() > 0)
                            <div class="mt-8 border-t border-gray-200 pt-2">
                                <h2 class="text-xl font-semibold text-gray-900 border-b-2 p-2 border-zinc-400">
                                    Components</h2>
                                        ...
                                        <div class="border-b py-2">
                                            <div class="flex justify-between">
                                                ...
                                                <div class="ml-4 flex flex-col items-end">
                                                    <span
                                                        class="text-sm font-medium text-gray-900">Qty: {{$component->quantity}}</span>
